 ...
 * 
 */
package com.bms.uaa.common.http;

import java.io.IOException;
import java.util.LinkedHashMap;
import java.util.Map;

import com.bms.uaa.common.ConfigUtil;
import com.bms.uaa.common.json.JsonFactory;
...
public class ResponseWithStatus implements Response{
	...
	public ResponseWithStatus(String request, Integer result_code, String result_msg) {
		super();
