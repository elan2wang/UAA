...
public class ConfigUtil {
	...
	static {
		...
		InputStream inputStream2 = Thread.currentThread().getContextClassLoader().getResourceAsStream("en_error_msg.properties");
		InputStream inputStream3 = Thread.currentThread().getContextClassLoader().getResourceAsStream("en_success_msg.properties");
